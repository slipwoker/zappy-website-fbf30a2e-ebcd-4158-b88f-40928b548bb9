      ...
      fetch(contactForm.action || window.location.href, {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            contactForm.reset();
            formFields.forEach(function (f) { clearFieldError(f); });
          } else {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fbf30a2e-ebcd-4158-b88f-40928b548bb9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fbf30a2e-ebcd-4158-b88f-40928b548bb9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fbf30a2e-ebcd-4158-b88f-40928b548bb9';
